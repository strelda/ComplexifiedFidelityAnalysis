...
- **SpinOperatorLibrary.m:** Mathematica library to construct the spin operator matrices (Jx, Jy, Jz).
- **Project.toml:** Project dependencies.
- **julia/src/SpinOperatorLibrary.jl:** Library to construct the spin operator matrices (Jx, Jy, Jz).
- **julia/src/LipkinModel.jl:** Module to build the Lipkin Hamiltonian and compute sorted eigen systems.
